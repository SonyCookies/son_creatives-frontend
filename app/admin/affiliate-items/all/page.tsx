...
import { AdminAffiliateItemsBrowser } from "@/components/admin-affiliate-items-browser";

export default function AdminAffiliateItemsAllPage() {
  return (
